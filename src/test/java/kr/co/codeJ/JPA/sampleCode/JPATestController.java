...
public class JPATestController {
	private static Logger logger=LoggerFactory.getLogger(JPATestController.class);
	@Autowired
...
//		throw new DBAccessException("test");
		return "main";
	}
...
//		JPATestClass	Mystart=context.getBean(JPATestClass.class);
//		mv.addObject("sourceType","DAO");
...
//		mv.addObject("sourceType","Annotation");
...
//		logger.info("InsertFactory: {}", myfactory.ToString());
//		JPATestClass	Mystart=context.getBean(JPATestClass.class);
